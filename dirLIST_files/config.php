...
$color_scheme_user_selectable = 0; //default = 1

//Default view mode: thumbnails or list. 0:Thumbnails 1:List
$view_mode                 = 1; //default = 0
$view_mode_user_selectable = 0; // 0:No 1:Yes
...
$language_user_selectable = 0; //Allow users to change the display language? 0:No, 1:Yes
...
$width_of_dates_column = "150"; //default = 125
